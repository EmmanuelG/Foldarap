...
#define STRING_CONFIG_H_AUTHOR "(Emmanuel, FoldaRap_Melzi 054)" //Who made the changes.
...
#define INVERT_E0_DIR false   // false for direct drive Nema14, true for mini-extruder
...
#define HOMING_FEEDRATE {1800, 1800, 115, 0}  // set the homing speeds (mm/min)
