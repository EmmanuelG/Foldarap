...
demo_gear([0,-15,0],diametralPitch);
...
union() {
gear (
	number_of_teeth=8*nmult,
	circular_pitch=300, 
	pressure_angle=19.34,
	gear_thickness=wheelSize/2*0.5,
	rim_thickness=wheelSize/2,
	rim_width = 5,
	hub_thickness=height/2*1.2,
	hub_diameter=15,
	bore_diameter=5,
	circles=4,  // holes in the gear
	backlash=0,twist=centerAngle/nmult,involute_facets=15);
...
*translate([0,-5,0+15/2]) rotate([90,30,0]) cylinder(h=3,r=m3_nut_diameter/2,center=true,$fn=6);
*translate([0,-5,16/2+15/2]) cube([6.1,3,16],center=true);
*translate([0,0,0+15/2]) rotate([90,0,0]) cylinder(r=3.2/2, h=20);
}
