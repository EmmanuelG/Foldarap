...
//%translate([-793.56,-622.28,0])import("foot-rear-right_melzi.stl");
//mirror([1,0,0])
render()union(){
// Base
difference(){
...
//		translate([0,-43,0])cube([97, 43, 3]);
		linear_extrude(height=3)polygon([[0,0], [83+footDepth, 0], [83+footDepth, -33], [73+footDepth, -43], [59, -43], [46, -35], [40, -35], [27, -43], [0, -43]]);
		...
		rotate([90,0,0])translate([26,0,0])linear_extrude(height=3)polygon([[0,0], [0, 11], [1, 11], [14, 5], [20,5], [33,11], [34,11], [34,0]]);
		rotate([90,0,0])translate([26,0,14])linear_extrude(height=4)polygon([[0,0], [0, 27], [2.3, 27], [2.3, 4], [31.7,4], [31.7,27], [34,27], [34,0]]);
		rotate([90,0,0])translate([26,3,18])linear_extrude(height=25)polygon([[0,0], [0, 4], [1, 0]]);
		rotate([90,0,0])translate([60,3,18])linear_extrude(height=25)polygon([[0,0], [0, 4], [-1, 0]]);
