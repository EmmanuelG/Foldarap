...
#define STRING_CONFIG_H_AUTHOR "(Emmanuel, FoldaRap 4 Minitronics)" // Who made the changes.
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {161, 161, 160, 280}  // 
#define DEFAULT_MAX_FEEDRATE          {300, 300, 300, 50}    // (mm/sec)
