...
#define STRING_CONFIG_H_AUTHOR "(Emmanuel, FoldaRap 2 Rumba)" // Who made the changes.
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {80.5, 80.2, 4000, 140}  // default steps per unit for Ultimaker
