...
#define STRING_CONFIG_H_AUTHOR "(Emmanuel, FoldaRap_003)" //Who made the changes.
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {80.2,80.2,3200,1200}  // FoldaRap direct drive Nema14, M5 leadscrew
#define DEFAULT_MAX_FEEDRATE          {400, 400, 3, 45}    // (mm/sec)
#define DEFAULT_MAX_ACCELERATION      {1500,1500,40,200}    // X, Y, Z, E maximum start speed for accelerated moves. E default values are good for skeinforge 40+, for older versions raise them a lot.
